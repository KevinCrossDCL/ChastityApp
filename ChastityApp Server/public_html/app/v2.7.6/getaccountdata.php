...
try {
    ...
    if ($userID1 == $userID2) {
        $query = $pdo->prepare("select 
            ...
            t1.last_recent_activity_id_seen as u_last_recent_activity_id_seen,
            ...
            t1.show_keyholder_stats_on_profile as u_show_keyholder_stats_on_profile,
            t1.show_lockee_stats_on_profile as u_show_lockee_stats_on_profile,
            t1.status as u_status,
            t1.timestamp_start_transfer as u_timestamp_start_transfer,
        ...
        from (select 
                ...
                show_keyholder_stats_on_profile,
                show_lockee_stats_on_profile,
                status,
                timestamp_start_transfer,
                twitter_handle
        ...
        if ($query->rowCount() > 0) {
            foreach ($query as $row) {
                ...
                $lastRecentActivityIDSeen = $row["u_last_recent_activity_id_seen"];
                $lockeeLevel = $row["u_lockee_level"];
                $mainRoleSelected = $row["u_main_role"];
                //$noOfKeys = $row["no_of_keys"];
                //$noOfKeysPurchased = $row["no_of_keys_purchased"];
                ...
                $showKeyholderStatsOnProfile = $row["u_show_keyholder_stats_on_profile"];
                $showLockeeStatsOnProfile = $row["u_show_lockee_stats_on_profile"];
                $statusSelected = $row["u_status"];
                $timestampStartTransferAccount = $row["u_timestamp_start_transfer"];
                if (time() - $timestampStartTransferAccount > 300) { $timestampStartTransferAccount = 0; }
            ...
            //array_push($JSON, array('variable' => 'adsRemoved', 'value' => $removedAds));
            ...
            //array_push($JSON, array('variable' => 'averageSecondsLocked', 'value' => $cumulativeSecondsLocked / $noOfLocks));
            array_push($JSON, array('variable' => 'banned', 'value' => $banned));
            //array_push($JSON, array('variable' => 'cumulativeSecondsLocked', 'value' => $cumulativeSecondsLocked));
            //array_push($JSON, array('variable' => 'dateJoined', 'value' => $dateJoined));
            ...
            //array_push($JSON, array('variable' => 'keyholderLevel', 'value' => $keyholderLevel));
            array_push($JSON, array('variable' => '$lastRecentActivityIDSeen', 'value' => $lastRecentActivityIDSeen));
            //array_push($JSON, array('variable' => 'lockeeLevel', 'value' => $lockeeLevel));
            //array_push($JSON, array('variable' => 'longestSecondsLocked', 'value' => $longestSecondsLocked));
            array_push($JSON, array('variable' => 'mainRoleSelected', 'value' => $mainRoleSelected));
            //array_push($JSON, array('variable' => 'noOfKeys', 'value' => $noOfKeys));
            //array_push($JSON, array('variable' => 'noOfKeysPurchased', 'value' => $noOfKeysPurchased));
            //array_push($JSON, array('variable' => 'noOfLocksCompleted', 'value' => $noOfLocksCompleted));
            ...
            array_push($JSON, array('variable' => 'showKeyholderStatsOnProfile', 'value' => $showKeyholderStatsOnProfile));
            array_push($JSON, array('variable' => 'showLockeeStatsOnProfile', 'value' => $showLockeeStatsOnProfile));
            ...
            array_push($JSON, array('variable' => '$timestampStartTransferAccount', 'value' => $timestampStartTransferAccount));
