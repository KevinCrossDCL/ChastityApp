...
try {
    ...
    if ($userID1 == $userID2) {
        $query = $pdo->prepare("select
            ...
            m.allow_free_unlock_modified_by as m_allow_free_unlock_modified_by,
        ...
        if ($query->rowCount() > 0) {
            foreach ($query as $row) {
                ...
                $allowFreeUnlockModifiedBy = $row["m_allow_free_unlock_modified_by"];
                ...
                array_push($JSON, array(
                    'id' => $modifiedID,
                    'lockID' => $lockID,
                    'allowFreeUnlockModifiedBy' => $allowFreeUnlockModifiedBy,
