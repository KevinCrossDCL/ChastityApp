    ...
    if ($userID1 == $userID2) {
        ...
        if ($_POST['usersTab'] == 2) {
            ...
            $query1 = $pdo->prepare("select
                ...
                u.timestamp_last_active as u_timestamp_last_active,
                u.username as u_username
            from Locks_V2 as l, UserIDs_V2 as u where l.shared_id = :sharedID and l.user_id <> :keyholderUserID and l.user_id = u.user_id and l.unlocked = 1 and l.fake = 0 order by l.timestamp_unlocked desc limit 199"); // limit 199");
        ...
        if ($_POST['usersTab'] == 3) {
            ...
            $query1 = $pdo->prepare("select
                ...
                u.timestamp_last_active as u_timestamp_last_active,
                u.username as u_username
            from Locks_V2 as l, UserIDs_V2 as u where l.shared_id = :sharedID and l.user_id <> :keyholderUserID and l.user_id = u.user_id and l.unlocked = 0 and l.deleted = 1 and l.fake = 0 order by l.timestamp_deleted desc limit 199");
            $query1->execute(array('sharedID' => $_POST['sharedID'], 'keyholderUserID' => $keyholderUserID));
            foreach ($query1 as $row1) {
