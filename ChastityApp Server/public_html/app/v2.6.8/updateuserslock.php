...
try {
    ...
    if ($userID1 == $userID2) {
        ...
        if ($query->rowCount() == 1) {
            ...
            if ($_POST['autoResetsPausedModifiedBy'] != 0 || $_POST['cardInfoHiddenModifiedBy'] != 0 || $_POST['cumulativeModifiedBy'] != 0 || $doubleUpCardsModifiedBy != 0 || $freezeCardsModifiedBy != 0 || $_POST['lockFrozenByKeyholderModifiedBy'] != 0 || $greenCardsModifiedBy != 0 || $minutesModifiedBy != 0 || $redCardsModifiedBy != 0 || $_POST['reset'] != 0 || $resetCardsModifiedBy != 0 || $stickyCardsModifiedBy != 0 || $_POST['timerHiddenModifiedBy'] != 0 || $noOfAdd1CardsModifiedBy != 0 || $noOfAdd2CardsModifiedBy != 0 || $noOfAdd3CardsModifiedBy != 0 || $noOfMinus1CardsModifiedBy != 0 || $noOfMinus2CardsModifiedBy != 0) {
