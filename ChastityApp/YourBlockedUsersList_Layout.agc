...
editYourBlockedUsersSearch as integer : editYourBlockedUsersSearch = OryUICreateTextfield("labelText:Search blocked users...;position:-1000,-1000;size:90,5;showTrailingIcon:true;trailingIcon:clear;depth:18")
