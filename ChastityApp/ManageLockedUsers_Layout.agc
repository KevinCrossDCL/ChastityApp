...
editLockedUsersSearch as integer : editLockedUsersSearch = OryUICreateTextfield("labelText:Search locked lockees...;position:-1000,-1000;size:90,5;showTrailingIcon:true;trailingIcon:clear;depth:18")
