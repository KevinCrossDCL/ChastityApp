...
editYourFollowingSearch as integer : editYourFollowingSearch = OryUICreateTextfield("labelText:Search following...;position:-1000,-1000;size:90,5;showTrailingIcon:true;trailingIcon:cancel;depth:18")
