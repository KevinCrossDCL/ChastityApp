...
editYourFollowersSearch as integer : editYourFollowersSearch = OryUICreateTextfield("labelText:Search followers...;position:-1000,-1000;size:90,5;showTrailingIcon:true;trailingIcon:clear;depth:18")
